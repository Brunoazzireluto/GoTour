...
Mas e se nós não precisássemos de comunicação? E se nós apenas quiséssemos
ter certeza que uma única goroutine pode acessar uma variável de cada vez para evitar conflitos?
...
A biblioteca padrão do Go que fornece exclusão mútua com sync.Mutex e seus dois métodos:
	...
	Lock
	Unlock
Podemos definir um bloco de código a ser executado em exclusão mútua pelo que o
rodeia com uma chamada para Lock e Unlock como mostrado no método Inc.
